...
export class HubCampaignCardComponent implements OnInit {
  ...
  constructor(protected modalRef: BsModalRef, protected hubService: InnovationsHubService, protected modalService: BsModalService) {}

  @Input()
  campaign: Campaign;

  configForCampaignSearch: SelectOptionConfig = {searchable: true, multipleOptions: false, clearable: false,

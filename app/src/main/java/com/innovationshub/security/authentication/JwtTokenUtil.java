package com.innovationshub.security.authentication;
...
/**
 * This class do the stuff like generating token, validating token etc.
 *
 * @author AJAYLAMBA
 * @since Jun 17, 2020 11:29 PM
 */
@Component
public class JwtTokenUtil implements Serializable {

    // Token validity in milliseconds - 24hr
